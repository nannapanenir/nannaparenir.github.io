    ...
    >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col items-center text-center md:items-start md:text-left space-y-6">
            ...
            <p className="text-slate-600 dark:text-slate-400 max-w-2xl text-xl">
              I design and develop web applications with modern technologies,
              specializing in enterprise-grade solutions with Java, Spring,
              React, and Angular.
            </p>
      ...
      <div className="absolute bottom-10 left-0 right-0 flex justify-center animate-bounce">
        <a
          ...
          className="p-2 bg-white dark:bg-slate-800 rounded-full shadow-md text-blue-600 dark:text-blue-400"
        >
          <ArrowDown size={20} />
        </a>
      </div>
